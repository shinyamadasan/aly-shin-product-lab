...
//  - Legacy quantity/cost inputs are protected inventory values, never editable metadata.
const EXCLUDED_INGREDIENT_FORM_FIELD_NAMES = ["id", "currentQuantity", "averageUnitCost"];
...
// low-stock threshold, target stock quantity, nearest expiration date, notes)
