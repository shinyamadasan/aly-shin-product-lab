...
### PROP-015 — Split "current valuation" from "immutable historical ledger" for inventory cost
...
### PROP-016 — Opportunity Pipeline Foundation
...
### PROP-017 — Fix ESLint ignore rules for nested git worktrees
...
### PROP-018 — Product form validation (duplicate names, whitespace, required fields)
...
### PROP-019 — Daily Advisor uses live Product catalog
